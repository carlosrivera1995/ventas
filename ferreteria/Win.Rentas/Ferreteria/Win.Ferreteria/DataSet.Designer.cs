...
namespace Win.Ferreteria {
    ...
    public partial class DataSet : global::System.Data.DataSet {
        ...
        public partial class ProductoDataTable : global::System.Data.TypedTableBase<ProductoRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public ProductoRow AddProductoRow(string Descripcion, double Precio, int Existencia, TipoRow parentTipoRowByTipo_Producto, byte[] Foto, bool Activo) {
...
namespace Win.Ferreteria.DataSetTableAdapters {
    ...
    public partial class ProductoTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Producto] WHERE (([Id] = @Original_Id) AND ([Precio] = @Origin" +
                ...
                "ipoId) AND ([Activo] = @Original_Activo))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Producto] ([Descripcion], [Precio], [Existencia], [TipoId], [Foto], [Activo]) VALUES (@Descripcion, @Precio, @Existencia, @TipoId, @Foto, @Activo);
SELECT Id, Descripcion, Precio, Existencia, TipoId, Foto, Activo FROM Producto WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Producto] SET [Descripcion] = @Descripcion, [Precio] = @Precio, [Existencia] = @Existencia, [TipoId] = @TipoId, [Foto] = @Foto, [Activo] = @Activo WHERE (([Id] = @Original_Id) AND ([Precio] = @Original_Precio) AND ([Existencia] = @Original_Existencia) AND ([TipoId] = @Original_TipoId) AND ([Activo] = @Original_Activo));
SELECT Id, Descripcion, Precio, Existencia, TipoId, Foto, Activo FROM Producto WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Win.Ferreteria.Properties.Settings.Default.FERRETERIAConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Descripcion, Precio, Existencia, TipoId, Foto, Activo FROM dbo.Product" +
                "o";
        ...
        public virtual int Delete(int Original_Id, double Original_Precio, int Original_Existencia, int Original_TipoId, bool Original_Activo) {
        ...
        public virtual int Insert(string Descripcion, double Precio, int Existencia, int TipoId, byte[] Foto, bool Activo) {
            if ((Descripcion == null)) {
        ...
        public virtual int Update(string Descripcion, double Precio, int Existencia, int TipoId, byte[] Foto, bool Activo, int Original_Id, double Original_Precio, int Original_Existencia, int Original_TipoId, bool Original_Activo, int Id) {
            if ((Descripcion == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Descripcion, double Precio, int Existencia, int TipoId, byte[] Foto, bool Activo, int Original_Id, double Original_Precio, int Original_Existencia, int Original_TipoId, bool Original_Activo) {
            return this.Update(Descripcion, Precio, Existencia, TipoId, Foto, Activo, Original_Id, Original_Precio, Original_Existencia, Original_TipoId, Original_Activo, Original_Id);
        }
    }
